...
public class GameBehaviour : Component, IStart, ICanvasComponent
{
    ...
    private void UIObjectClick(UIEvent tileClick)
    {
        ...
        TileData data = _lines.GetTileDataByButton(clicked.GetComponent<SelectableButton>());
    ...
    private void UIObjectEnter(UIEvent tileEnter)
    {
        ...
        TileData data = _lines.GetTileDataByButton(entered.GetComponent<SelectableButton>());
