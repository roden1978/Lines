...
public class Scene
{
    ...
    public Scene(string name, Canvas canvas, GraphicsDevice graphicsDevice)
    {
        Name = name;
        _canvas = canvas;
    ...
    {
        spriteBatch.Begin(SpriteSortMode.BackToFront, BlendState.NonPremultiplied, null, null, RasterizerState.CullClockwise, _spriteBatchEffect);
