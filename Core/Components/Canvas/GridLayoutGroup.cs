...
public class GridLayoutGroup : Component, IStart, ICanvasComponent
{
    ...
    private void UpdateItemsPositions()
    {
        ...
        float absolutePositionX = gameObject.Transform.Parent == null 
            ? gameObject.Transform.Position.X 
            : gameObject.Transform.Parent.AbsolutePosition.X;
        float absolutePositionY = gameObject.Transform.Parent == null 
            ? gameObject.Transform.Position.Y
            : gameObject.Transform.Parent.AbsolutePosition.Y;
